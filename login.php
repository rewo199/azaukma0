...
$password = "";     // ใส่ password (ปกติจะว่างไว้)
...
<body>
    ...
    <div class="wrapper"> 
    <div class="container">
        <img src="assets/images/logo.png" class="logo" alt="โลโก้ UinJob">
    ...
    <div class="card">
      <div class="tabs">
        ...
        <button type="button"  class="sub-tab" onclick="showCompany()">Admin</button>
        </div>
